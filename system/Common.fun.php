...
function autoLoadClass($class){
	...
	$class=join('/',$classArr);
	$class= str_replace(array('\\rp','rp'), LIBPATH, $class);
	$class= str_replace(array('\\plugin','plugin'), PLUGINPATH, $class);
	$class= str_replace(array('\\template','template'), TMPPATH, $class);
